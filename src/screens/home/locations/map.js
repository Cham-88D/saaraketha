...
const Map = () => {
  ...
  return (
    ...
    >
     <StatusBar style="dark" hidden = {false} backgroundColor = "#bbff4d" translucent = {true}/>
      <View style={styles.container}>
        ...
        >
          {!loading && locations.map((data, index) => (
            <Marker
      ...
      >
        ...
        <MaterialCommunityIcons name="map-marker" size={60} color="black" style={styles.bottomMarker} />
          <Text
            style={[
              styles.bootmTitle
            ]}
          ...
          <View>
            <View style={styles.row}>
              ...
              <Text style={[styles.bottomText, styles.diseseText]}>{selecLocation.disease}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.bottomText}>Latitude:</Text>
              <Text style={[styles.bottomText, styles.locationText]}>{selecLocation.coordinate.latitude}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.bottomText}>Latitude:</Text>
              <Text style={[styles.bottomText, styles.locationText]}>{selecLocation.coordinate.longitude}</Text>
            </View>
            <Pressable
              style={[styles.groupView,styles.calcButton]}
              onPress={() => navigation.navigate("HeatMap",{data:selecLocation})}
            >
              <LinearGradient
            ...
            >
              <LinearGradient
                ...
                colors={["#000", "#222"]}
              />
              <Text style={[styles.diseaseDetection, styles.ravinduTypo,{color:"#fff"}]}>
              Spray 
              </Text>
            </Pressable>
            </View>
